...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    ref(data.home.video);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_HeroComponent = _sfc_main$4;
      const _component_EventCard = _sfc_main$2;
      const _component_ServiceCard = _sfc_main$1;
